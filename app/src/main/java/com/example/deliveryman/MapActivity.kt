...
import com.example.deliveryman.helper.GoogleMapHelper
import com.example.deliveryman.helper.MarkerAnimationHelper
import com.example.deliveryman.helper.UiHelper
...
import com.example.deliveryman.helper.*
import com.example.deliveryman.interfaces.IPositiveNegativeListener
import com.example.deliveryman.interfaces.LatLngInterpolator
...
class MapActivity : AppCompatActivity() {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putBoolean("driverOnlineFlag", driverOnlineFlag) // Save value of i which is integer into counter
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle ) {
        ...
        driverOnlineFlag=savedInstanceState.getBoolean("driverOnlineFlag") // Value that was saved will restore to variable
